...
/** Abstract class to produce the document graph in a serializable format. */
public abstract class AbstractDocumentGraphFormatConsumer extends AbstractDocumentGraphConsumer {
