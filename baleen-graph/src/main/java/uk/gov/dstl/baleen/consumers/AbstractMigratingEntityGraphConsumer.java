...
/**
 * This abstract class takes the created entity graph and migrates it to the given implemented
 * graph.
 *
 ...
 */
public abstract class AbstractMigratingEntityGraphConsumer extends AbstractEntityGraphConsumer {
  ...
  public void doInitialize(UimaContext aContext) throws ResourceInitializationException {
    ...
    try {
      ...
      // sanity check this property for the implementation
      if (multiValueProperties && !g.features().vertex().supportsMultiProperties()) {
        multiValueProperties = false;
      }
