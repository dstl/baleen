...
public class SqlDbCellReaderTest extends AbstractReaderTest {
    ...
    public void test() throws Exception{
        ...
        BaleenCollectionReader bcr = getCollectionReader(SqlDbCellReader.PARAM_SQL_CONNECTION, "jdbc:h2:mem:test",
                SqlDbCellReader.PARAM_SQL_IGNORE_COLUMNS, new String[]{"MY_TABLE.ignore_me", "MY_TABLE.id", "MY_TABLE2.id"});
    ...
    private void setup() throws Exception{
        ...
        conn.prepareStatement("CREATE TABLE my_table (id int primary key, ignore_me varchar(255), text_column1 varchar(255), text_column2 varchar(255))").execute();

        conn.prepareStatement("INSERT INTO my_table " +
                "(id, ignore_me, text_column1, text_column2) VALUES " +
                "(1, 'IGNORE', 'TEXT BLOCK 1', 'TEXT BLOCK 2')").execute();
        conn.prepareStatement("INSERT INTO my_table " +
                "(id, ignore_me, text_column1, text_column2) VALUES " +
                "(2, 'IGNORE', 'TEXT BLOCK 1', 'TEXT BLOCK 2')").execute();

        conn.prepareStatement("CREATE TABLE my_table2 (id int primary key, ignore_me varchar(255), text_column1 varchar(255), text_column2 varchar(255))").execute();

        conn.prepareStatement("INSERT INTO my_table2 " +
                "(id, ignore_me, text_column1, text_column2) VALUES " +
                "(3, 'IGNORE', 'TEXT BLOCK 1', 'TEXT BLOCK 2')").execute();
    }
