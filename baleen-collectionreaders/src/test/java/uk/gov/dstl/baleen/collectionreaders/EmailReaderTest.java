...
public class EmailReaderTest extends AbstractReaderTest {
  @Rule public final GreenMailRule greenMail = new GreenMailRule(ServerSetupTest.SMTP_POP3_IMAP);
  ...
  public void testPopMetadata() throws Exception {
    ...
    MimeMessage ccMessage =
        GreenMailUtil.createTextEmail(
            "to@localhost.com", "from@localhost.com", subject2, body2, ServerSetupTest.SMTP);
