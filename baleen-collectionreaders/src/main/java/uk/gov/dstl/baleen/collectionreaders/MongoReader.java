 ...
 *
 * <p>The ObjectId (_id) is used to sort documents and to identify new documents. This may miss
 * documents if there is a high write rate, or if documents are being inserted by multiple clients.
 * For more information, see http://docs.mongodb.org/manual/reference/object-id/
 *
 * @baleen.javadoc
 */
