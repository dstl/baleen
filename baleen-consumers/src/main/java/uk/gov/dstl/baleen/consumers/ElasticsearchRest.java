...
/**
 * Use the Elasticsearch REST API to save processed documents, using the schema defined in
 * AbstractElasticsearchConsumer.
 *
 * <p>Because we use the REST API, this should be compatible with all versions of Elasticsearch.
 *
 * @baleen.javadoc
 */
