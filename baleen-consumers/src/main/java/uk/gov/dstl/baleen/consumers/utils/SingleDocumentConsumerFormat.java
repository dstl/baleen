...
/**
 * Helper class for converting a CAS object into a single document
 * (i.e. with entities and relations embedded) for persistence using
 ...
 * 
 * Use of this class ensures consistency of formats across databases, e.g. Elasticsearch and ActiveMQ
 */
public class SingleDocumentConsumerFormat {
	 ...
	 * 
	 * @param jCas
	 * @param contentHashAsId
	 * 		Should a hash of the content be used to generate the ID? If false, then a hash of the Source URI is used instead.
	 * @param fields
	 * 		An instance of IEntityConverterFields to be used 
	 * @param monitor
	 * @param support
	 * 
	 * @return
	 * 		Standardised representation of jCas
	 */
	public static Map<String, Object> formatCas(JCas jCas, IEntityConverterFields fields, boolean contentHashAsId, UimaMonitor monitor, UimaSupport support){
	...
	/**
	 * Create a map of all metadata objects in a collection.
	 * Duplicate key values will be converted into a list of objects.
	 */
