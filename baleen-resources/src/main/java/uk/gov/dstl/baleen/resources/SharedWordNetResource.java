...
public class SharedWordNetResource extends BaleenResource {
   ...
   *
   * <p>The supersense is the original 'sense file' in which word was defined.
   *
   * @param pos the pos
   * @param word the word
   ...
   *
   * <p>Since the lexfile has filename "noun.cogition" we remove the "noun." so that verb based and
