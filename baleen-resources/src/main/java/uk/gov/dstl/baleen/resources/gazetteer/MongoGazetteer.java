...
public class MongoGazetteer extends AbstractMultiMapGazetteer<ObjectId> {
  ...
  /**
   * Configure a new instance of MongoGazetteer. The following config parameters are
   * expected/allowed:
   *
   * <ul>
   *   <li><b>collection</b> - The collection containing the gazetteer; defaults to gazetteer
   *   <li><b>valueField</b> - The field containing the gazetteer values; defaults to value
   * </ul>
   *
   ...
   * @throws InvalidParameterException if the passed connection parameter is not a
   *     SharedMongoResource
   */
  @Override
  public void init(Resource connection, Map<String, Object> config) throws BaleenException {
    ...
    try {
      ...
      throw new InvalidParameterException(
          "Unable to cast connection parameter to SharedMongoResource", cce);
    }
