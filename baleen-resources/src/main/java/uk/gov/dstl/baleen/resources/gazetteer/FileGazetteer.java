...
public class FileGazetteer extends AbstractMultiMapGazetteer<Integer> {
  ...
  /**
   * Configure a new instance of FileGazetteer. The following config parameters are
   * expected/allowed:
   *
   * <ul>
   *   <li><b>fileName</b> - What file are we using for the gazetteer; defaults to gazetteer.txt
