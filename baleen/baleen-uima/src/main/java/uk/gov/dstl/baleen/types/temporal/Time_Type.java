...
/** A time reference - 12 or 24 hours - within the document.
...
public class Time_Type extends Temporal_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.temporal.Time");
