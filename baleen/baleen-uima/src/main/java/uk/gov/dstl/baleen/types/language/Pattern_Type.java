...
public class Pattern_Type extends Base_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.language.Pattern");
  ...
  public Pattern_Type(JCas jcas, Type casType) {
    ...
    casFeat_source = jcas.getRequiredFeatureDE(casType, "source", "uk.gov.dstl.baleen.types.Base", featOkTst);
    casFeatCode_source  = (null == casFeat_source) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_source).getCode();

 
    casFeat_target = jcas.getRequiredFeatureDE(casType, "target", "uk.gov.dstl.baleen.types.Base", featOkTst);
