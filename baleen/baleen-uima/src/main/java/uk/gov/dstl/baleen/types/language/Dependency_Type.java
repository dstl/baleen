...
public class Dependency_Type extends Base_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.language.Dependency");
  ...
  public Dependency_Type(JCas jcas, Type casType) {
    ...
    casFeat_governor = jcas.getRequiredFeatureDE(casType, "governor", "uk.gov.dstl.baleen.types.language.WordToken", featOkTst);
    casFeatCode_governor  = (null == casFeat_governor) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_governor).getCode();

 
    casFeat_dependent = jcas.getRequiredFeatureDE(casType, "dependent", "uk.gov.dstl.baleen.types.language.WordToken", featOkTst);
