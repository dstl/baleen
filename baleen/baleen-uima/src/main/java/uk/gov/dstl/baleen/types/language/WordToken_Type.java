...
public class WordToken_Type extends Base_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.language.WordToken");
  ...
  public WordToken_Type(JCas jcas, Type casType) {
    ...
    casFeatCode_lemmas  = (null == casFeat_lemmas) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_lemmas).getCode();
