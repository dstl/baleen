...
public class PhraseChunk_Type extends Base_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.language.PhraseChunk");
  ...
  public void setConstituentWords(int addr, int i, int v) {
      ...
      jcas.throwFeatMissing("constituentWords", "uk.gov.dstl.baleen.types.language.PhraseChunk");
    if (lowLevelTypeChecks)
      ll_cas.ll_setRefArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_constituentWords), i, v, true);
    jcas.checkArrayBounds(ll_cas.ll_getRefValue(addr, casFeatCode_constituentWords), i);
  ...
  public PhraseChunk_Type(JCas jcas, Type casType) {
    ...
    casFeat_constituentWords = jcas.getRequiredFeatureDE(casType, "constituentWords", "uima.cas.FSArray", featOkTst);
    casFeatCode_constituentWords  = (null == casFeat_constituentWords) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_constituentWords).getCode();

 
    casFeat_headWord = jcas.getRequiredFeatureDE(casType, "headWord", "uk.gov.dstl.baleen.types.language.WordToken", featOkTst);
