...
public class PhraseChunk extends Base {
  ...
  */  
  ...
  public FSArray getConstituentWords() {
    if (PhraseChunk_Type.featOkTst && ((PhraseChunk_Type)jcasType).casFeat_constituentWords == null)
      jcasType.jcas.throwFeatMissing("constituentWords", "uk.gov.dstl.baleen.types.language.PhraseChunk");
    return (FSArray)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((PhraseChunk_Type)jcasType).casFeatCode_constituentWords)));}
  ...
  public void setConstituentWords(FSArray v) {
    if (PhraseChunk_Type.featOkTst && ((PhraseChunk_Type)jcasType).casFeat_constituentWords == null)
      jcasType.jcas.throwFeatMissing("constituentWords", "uk.gov.dstl.baleen.types.language.PhraseChunk");
    jcasType.ll_cas.ll_setRefValue(addr, ((PhraseChunk_Type)jcasType).casFeatCode_constituentWords, jcasType.ll_cas.ll_getFSRef(v));}    
    
  /** indexed getter for constituentWords - gets an indexed value - Word tokens which comprose the constituent.
   * @generated
  ...
  public WordToken getConstituentWords(int i) {
    if (PhraseChunk_Type.featOkTst && ((PhraseChunk_Type)jcasType).casFeat_constituentWords == null)
      jcasType.jcas.throwFeatMissing("constituentWords", "uk.gov.dstl.baleen.types.language.PhraseChunk");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((PhraseChunk_Type)jcasType).casFeatCode_constituentWords), i);
    return (WordToken)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((PhraseChunk_Type)jcasType).casFeatCode_constituentWords), i)));}

  /** indexed setter for constituentWords - sets an indexed value - Word tokens which comprose the constituent.
   * @generated
  ...
  public void setConstituentWords(int i, WordToken v) { 
    if (PhraseChunk_Type.featOkTst && ((PhraseChunk_Type)jcasType).casFeat_constituentWords == null)
      jcasType.jcas.throwFeatMissing("constituentWords", "uk.gov.dstl.baleen.types.language.PhraseChunk");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((PhraseChunk_Type)jcasType).casFeatCode_constituentWords), i);
    jcasType.ll_cas.ll_setRefArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((PhraseChunk_Type)jcasType).casFeatCode_constituentWords), i, jcasType.ll_cas.ll_getFSRef(v));}
  ...
  public WordToken getHeadWord() {
    ...
    return (WordToken)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((PhraseChunk_Type)jcasType).casFeatCode_headWord)));}
  ...
  public void setHeadWord(WordToken v) {
    if (PhraseChunk_Type.featOkTst && ((PhraseChunk_Type)jcasType).casFeat_headWord == null)
      jcasType.jcas.throwFeatMissing("headWord", "uk.gov.dstl.baleen.types.language.PhraseChunk");
    jcasType.ll_cas.ll_setRefValue(addr, ((PhraseChunk_Type)jcasType).casFeatCode_headWord, jcasType.ll_cas.ll_getFSRef(v));}    
  }
