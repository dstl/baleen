...
public class PublishedId extends BaleenAnnotation {
  ...
  public final static int typeIndexID = JCasRegistry.register(PublishedId.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected PublishedId() {/* intentionally empty block */}
  ...
  */  
  ...
  /** getter for publishedIdType - gets The type of PublishedID that this particular annotation refers to
   * @generated
   * @return value of the feature 
   */
  public String getPublishedIdType() {
    if (PublishedId_Type.featOkTst && ((PublishedId_Type)jcasType).casFeat_publishedIdType == null)
      jcasType.jcas.throwFeatMissing("publishedIdType", "uk.gov.dstl.baleen.types.metadata.PublishedId");
    return jcasType.ll_cas.ll_getStringValue(addr, ((PublishedId_Type)jcasType).casFeatCode_publishedIdType);}
    
  /** setter for publishedIdType - sets The type of PublishedID that this particular annotation refers to 
   * @generated
   * @param v value to set into the feature 
   */
  public void setPublishedIdType(String v) {
    if (PublishedId_Type.featOkTst && ((PublishedId_Type)jcasType).casFeat_publishedIdType == null)
      jcasType.jcas.throwFeatMissing("publishedIdType", "uk.gov.dstl.baleen.types.metadata.PublishedId");
    jcasType.ll_cas.ll_setStringValue(addr, ((PublishedId_Type)jcasType).casFeatCode_publishedIdType, v);}    
  }
