...
public class CountryGazetteerTest extends AbstractAnnotatorTest{
	private static final String COUNTRY = "country";
	private static final String PREFIX = "Last month, Peter visited the coast of ";

	private final ExternalResourceDescription erd = ExternalResourceFactory.createExternalResourceDescription(COUNTRY, SharedCountryResource.class);
	
	public CountryGazetteerTest(){
		super(Country.class);
	}
	...
	public void testUTF() throws Exception{
		jCas.setDocumentText(PREFIX+"\u062c\u0645\u0647\u0648\u0631\u064a\u0629 \u062c\u064a\u0628\u0648\u062a\u064a");
		processJCas(COUNTRY, erd);
		
		testJCas(jCas, "\u062c\u0645\u0647\u0648\u0631\u064a\u0629 \u062c\u064a\u0628\u0648\u062a\u064a");
	}
