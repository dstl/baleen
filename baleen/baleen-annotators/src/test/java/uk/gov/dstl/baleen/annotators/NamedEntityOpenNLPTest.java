...
import uk.gov.dstl.baleen.annotators.stats.OpenNLP;
 ...
 * 
 */
public class NamedEntityOpenNLPTest extends AnnotatorTestBase {
	...
	public void testCorrupt() throws Exception {
		AnalysisEngineDescription desc = AnalysisEngineFactory.createEngineDescription(OpenNLP.class, TYPE, PERSON, MODEL, getClass().getResource("gazetteer.txt").getPath());
