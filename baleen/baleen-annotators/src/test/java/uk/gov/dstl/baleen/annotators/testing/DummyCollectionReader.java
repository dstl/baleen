 ...
 * 
 */
public class DummyCollectionReader extends BaleenCollectionReader {
	...
	public Progress[] doGetProgress() {
		return new Progress[] { new ProgressImpl(DOCUMENT_COUNT - documents.size(), DOCUMENT_COUNT, Progress.ENTITIES) };
	}
