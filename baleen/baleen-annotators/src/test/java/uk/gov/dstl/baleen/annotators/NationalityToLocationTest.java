...
import uk.gov.dstl.baleen.annotators.misc.NationalityToLocation;
...
public class NationalityToLocationTest extends AnnotatorTestBase {
	...
	public void beforeTest() throws UIMAException{
		...
		AnalysisEngineDescription aed = AnalysisEngineFactory.createEngineDescription(NationalityToLocation.class, "country", erd);
