...
import uk.gov.dstl.baleen.annotators.cleaners.RemoveLowConfidenceEntities;
...
public class RemoveLowConfidenceEntitiesTest extends AnnotatorTestBase {
	...
	public void test() throws Exception{
		AnalysisEngine rpeAE = AnalysisEngineFactory.createEngine(RemoveLowConfidenceEntities.class, "confidenceThreshold", "0.75");
