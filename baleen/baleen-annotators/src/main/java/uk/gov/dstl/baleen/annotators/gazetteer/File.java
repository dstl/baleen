...
/**
 * Generic file-backed RadixTree Gazetteer annotator, that will use a file based gazetteer to find and annotate entities.
 * 
 * 
 * @baleen.javadoc
 */
public class File extends AbstractAhoCorasickAnnotator {
	...
	/**
	 * The file, which is expected to be a line separated gazetteer with aliases comma-separated (by default) on the same line, to use as the gazetteer
	 * 
