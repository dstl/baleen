...
/**
 * Where an entity is followed by something that may be it's initials in brackets,
 * associate those initials with the entity and extract other occurrences.
 * 
 * For the purposes of this annotator, initials are defined as an uppercase string
 * containing only letters that appear in the entity (in the correct order).
 * 
 * For example LDN would be accepted as initials for London,
