...
/**
 * Finds Money values without an assigned currency, and tries to determine what currency they are by matching against a list of currency symbols and terms
 * 
 * 
 */
