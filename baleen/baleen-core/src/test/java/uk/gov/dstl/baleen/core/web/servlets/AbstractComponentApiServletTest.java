...
public class AbstractComponentApiServletTest {
	...
	public void testClassFromString() throws Exception{
		AbstractComponentApiServlet servlet = new AbstractComponentApiServlet("java.util.List", "java.util", Collections.emptyList(), Collections.emptyList(), this.getClass());
