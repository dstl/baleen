...
/**
 * Represents and controls single CPE.
 *
 * This is used to build different types of CPE backed instances, for example the BaleenPipeline and
 * BaleenJob.
 *
 * Implements may which to override the StatusCallbackListeners to added logging useful to that
 * particular controller.
 *
 */
public abstract class AbstractCpeController implements StatusCallbackListener {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(AbstractCpeController.class);
	 ...
	 *            non-null
	 */
	protected AbstractCpeController(String name, String yaml,
	 ...
	 *            non-null
	 */
	protected AbstractCpeController(String name, String yaml, File source,
			CollectionProcessingEngine engine) {
		this.name = name;
		this.yaml = yaml;
		this.source = source;
		this.engine = engine;
		this.metrics = MetricsFactory.getMetrics(name, AbstractCpeController.class);
	 ...
	 *            non-null
	 */
	protected AbstractCpeController(String name, CollectionProcessingEngine engine) {
