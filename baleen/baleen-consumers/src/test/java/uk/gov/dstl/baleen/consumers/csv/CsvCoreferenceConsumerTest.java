...
public class CsvCoreferenceConsumerTest extends AbstractAnnotatorTest {
	...
	ExternalResourceDescription stopwordsDesc = ExternalResourceFactory.createExternalResourceDescription(Coreference.KEY_STOPWORDS, SharedStopwordResource.class);
