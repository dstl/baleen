...
import uk.gov.dstl.baleen.annotators.regex.Hms;
...
public class HmsTest extends AbstractAnnotatorTest {
	...
	public void testHms() throws Exception{
		jCas.setDocumentText("HMS Troutbridge sailed into New York last Friday. H.M.S. Hidden Dragon provided an escort.");
		process();
	...
	public void testHmsVariants() throws Exception{
		jCas.setDocumentText("HMJS Troutbridge sailed into New York last Friday. H.M.P.N.G.S. Hidden Dragon provided an escort.");
		process();
