...
public class TemplateRecordDefinitionAnnotatorTest extends AbstractAnnotatorTest {
	...
	public void annotateRecord() throws AnalysisEngineProcessException, ResourceInitializationException {
		...
		processJCas();
		TemplateRecordDefinition record = JCasUtil.selectByIndex(jCas, TemplateRecordDefinition.class, 0);
	...
	public void annotate2Record() throws AnalysisEngineProcessException, ResourceInitializationException {
		...
		TemplateRecordDefinition record2 = JCasUtil.selectByIndex(jCas, TemplateRecordDefinition.class, 1);
	...
	@Test
	public void annotateRepeatingRecord() throws AnalysisEngineProcessException, ResourceInitializationException {
