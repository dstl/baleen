...
public class DocumentTypeTest extends AbstractAnnotatorTest {
	...
	public void testInitialiseError() throws Exception {
		...
		processJCas(DocumentType.PARAM_MODEL, getClass().getResource("not_a_model.txt").getPath(), DocumentType.PARAM_CONFIDENCE_THRESHOLD, "0.5");	// "gazetteer.txt" is not a model...		
	}
