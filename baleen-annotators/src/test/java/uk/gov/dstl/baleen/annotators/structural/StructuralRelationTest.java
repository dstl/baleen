...
public class StructuralRelationTest extends AbstractAnnotatorTest {
	...
	private int addRow(int depth, int cursor, String cell1, String cell2, boolean person, boolean comms) {
	...
	public void testProcess() throws Exception {
		...
		processJCas(PARAM_QUERY,
				"Table:has(TableHeader:matches((?i)name):matches((?i)email)) TableRow:has(Person):has(CommsIdentifier)",
				PARAM_SOURCE_QUERY, "Person", PARAM_TARGET_QUERY, "CommsIdentifier", PARAM_TYPE, "emailAddress",
				PARAM_SUB_TYPE, "sub");
