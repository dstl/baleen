...
import uk.gov.dstl.baleen.annotators.grammatical.NPAtCoordinate;
...
public class NPAtCoordinateTest extends AbstractAnnotatorTest{
	...
	public void testLocationBothRT() throws Exception{
		jCas.setDocumentText("The former school house at GR 1234 5678. The school house has a blue door.");
