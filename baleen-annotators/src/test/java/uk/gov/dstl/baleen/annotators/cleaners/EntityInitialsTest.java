...
public class EntityInitialsTest extends AbstractAnnotatorTest {
	...
	public void test1() throws Exception{
		jCas.setDocumentText("John Smith (JS) was last seen in London (LDN). JS has previously visited LDN.");
	...
	public void test2() throws Exception{
		jCas.setDocumentText("John Smith (UID123) (JS) was last seen in London (LDN) (NFDK). JSmith has previously visited MAN.");
