...
import uk.gov.dstl.baleen.annotators.grammatical.NPElement;
...
public class NPElementTest extends AbstractAnnotatorTest{
	...
	public void test() throws Exception{
		jCas.setDocumentText("He used hydrogen peroxide to dye his hair. The diamond was made of carbon-12.");
		
		languageAE.process(jCas);
		processJCas();
		assertEquals(2, JCasUtil.select(jCas, Chemical.class).size());
		
		assertEquals("hydrogen peroxide", JCasUtil.selectByIndex(jCas, Chemical.class, 0).getCoveredText());
