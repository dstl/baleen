...
public class TemplateFieldDefinitionAnnotatorTest extends AbstractAnnotatorTest {
	...
	private static final String FIELD_REGEX_DEFAULT_REQUIRED_TEXT = "<<field:all regex=\"\\d?:\\s\\d?\" defaultValue=\"not found\" required=\"true\" repeat=\"true\">>";
	private static final String FIELD_REGEX_DEFAULT_REQUIRED_TEXT_LENIENT = "<<field:all regex=\"\\d?:\\s\\d?\" defaultValue=\"not found\" required repeat>>";
	...
	@Test
	public void annotateFieldRepeat() throws AnalysisEngineProcessException, ResourceInitializationException {
