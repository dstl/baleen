...
public class RecordStructureManagerTest {
	...
	public void setUp() throws Exception {
		...
		recordStructureManager = new RecordStructureManager(
	...
	public void testGetFirstParagraph() throws InvalidParameterException {
		Optional<Structure> structure = recordStructureManager.select("Document > Paragraph:nth-of-type(1)");
	...
	public void testCanGetAfterRepeatParagraph() throws InvalidParameterException {
		...
		Optional<Structure> adjusted = recordStructureManager.select("Document > Paragraph:nth-of-type(2)");
	...
	public void testCanRepeatFromStartOfDocument() throws InvalidParameterException {
		...
		Optional<Structure> repeat1 = recordStructureManager.repeatRecord(Optional.empty(), repeatUnit, true);
		assertTrue(repeat1.isPresent());
