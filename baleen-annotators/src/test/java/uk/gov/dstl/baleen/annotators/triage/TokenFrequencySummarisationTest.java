    ...
    protected AnalysisEngine[] createAnalysisEngines() throws ResourceInitializationException {
        ...
        AnalysisEngineDescription openNlpAnalysisEngineDescription =
                AnalysisEngineFactory.createEngineDescription(
                        OpenNLP.class,
                        "tokens", tokensDesc,
                        "sentences", sentencesDesc,
                        "posTags", posDesc,
                        "phraseChunks", chunksDesc);

        AnalysisEngineDescription wordNetLemmatizerAnalysisEngineDescription =
                AnalysisEngineFactory.createEngineDescription(WordNetLemmatizer.class,
                        "wordnet", wordnetDesc);

        AnalysisEngineDescription tokenFrequencySummarisationAnalysisEngineDescription =
                AnalysisEngineFactory.createEngineDescription(TokenFrequencySummarisation.class,
                        "stopwords", stopwordsDesc);
        ...
        return new AnalysisEngine[] {openNlpAnalysisEngine, wordNetLemmatizerAnalysisEngine, tokenFrequencySummarisationAnalysisEngine};
    }
