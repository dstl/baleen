...
public class LenientUrlTest extends AbstractAnnotatorTest {
    ...
    public void test() throws Exception{
        jCas.setDocumentText("If you visit bbc.co.uk, then you may also want to visit bbc.co.uk/news or http://news.bbc.co.uk, or even news.bbc.co.uk/stories/view.php?id=123. But don't pull out james@example.com");
        processJCas();
