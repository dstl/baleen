...
import uk.gov.dstl.baleen.annotators.misc.Pronouns;
...
public class PronounsTest extends AbstractAnnotatorTest{
	...
	public void testPlural() throws Exception{
		jCas.setDocumentText("They were last seen running towards the school, making a nuisance of themselves.");
		addWordTokens(jCas);
		...
		assertEquals("themselves", JCasUtil.selectByIndex(jCas, Organisation.class, 1).getCoveredText());
