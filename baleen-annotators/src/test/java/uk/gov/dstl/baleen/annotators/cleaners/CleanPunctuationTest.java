...
import uk.gov.dstl.baleen.annotators.cleaners.CleanPunctuation;
...
public class CleanPunctuationTest extends AnnotatorTestBase{
	...
	private static final String TEXT_BRACKETS = "((Oh dear), we've (pulled out) too many opening brackets";
