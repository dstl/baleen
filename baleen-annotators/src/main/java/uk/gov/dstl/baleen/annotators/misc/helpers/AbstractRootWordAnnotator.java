...
/**
 * Abstract annotator that identifies a root word indicative of an entity, and then identifies
 * modifiers/descriptive words prior to that root word to build up a complete entity.
 *
 * <p>For example, it might identify 'car' as a vehicle, and then 'red' as a modifier to produce an
 * entity 'red car'.
 */
