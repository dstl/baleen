 ...
 *
 * <p>Loops through a list of blacklisted entity values supplied by the user, and if an entity value
 * matches one on the blacklist that entity is removed. This can be done either case sensitive or
 * case insensitive (the default), and for specific entity types or all entity types.
 *
 * @baleen.javadoc
 */
public class Blacklist extends BaleenAnnotator {
  ...
  public AnalysisEngineAction getAction() {
    return new AnalysisEngineAction(ImmutableSet.of(et), Collections.emptySet());
  }
}
