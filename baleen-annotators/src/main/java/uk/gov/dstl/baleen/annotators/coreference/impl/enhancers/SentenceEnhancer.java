 ...
 *
 * <p>Thanks to UIMA this is a tremendous amount of work for such a simple task.
 */
public class SentenceEnhancer {
  ...
  private void setSentence(
      Mention m, Collection<Sentence> sentenceCollection, Map<Sentence, Integer> sentenceIndex) {
    Sentence s = null;
