 ...
 *
 * <p>For example, in the statement "the former school house at GR 1234 5678", we would identify
 * "the former school house" as a location and a coreference between it and "GR 1234 5678".
 *
 * <p>If an existing Location exists, that is used and NP are ignored. Otherwise a new Location is
 * created to match the NP.
 *
 * @baleen.javadoc
 */
public class NPAtCoordinate extends BaleenAnnotator {
  ...
  public AnalysisEngineAction getAction() {
    return new AnalysisEngineAction(
        ImmutableSet.of(Coordinate.class, Location.class, PhraseChunk.class),
        ImmutableSet.of(Location.class));
  }
}
