 ...
 *
 * Through {@link PipelineBuilder} there will be a single instance of the BaleenHistory
 * within a pipeline.
 */
public interface BaleenHistory extends Resource {
	 ...
	 * 
	 * The value of this setting determines if entities with different referent targets will be merged (true). If set to
	 ...
	 * individual annotators. It defaults to false.
	 */
