...
public class BaleenDefaults {
  ...
  public static final String DEFAULT_CONTENT_EXTRACTOR =
      "uk.gov.dstl.baleen.contentextractors.StructureContentExtractor";
  ...
  public static final String DEFAULT_CONTENT_MANIPULATOR_PACKAGE =
