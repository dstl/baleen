...
/**
 * Identifies an (UIMA) annotation (or annotation subtype) as one which should be recorded in the
 * history system.
 *
 * <p>You should manually add this to any annotation which is to be recorded by the history system.
 *
 * <p>The interface deliberately overlays onto the UIMA, such that the history system can be
