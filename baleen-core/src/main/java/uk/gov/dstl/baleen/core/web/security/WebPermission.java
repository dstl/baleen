...
public class WebPermission {
	...
	/**
	 * New instance requiring an authenticated user with specific roles
	 * accessing via a specific HTTP method type.
	 *
	 * @param name
	 * @param method
	 * @param roles
	...
	/**
	 * Get the method which must be used to access a resource with this
	 * permission.
	 *
	 ...
	 *
	 * @return true is this permission has role restrictions (getRoles will be
	 *         non-empty)
	 */
