 ...
 *
 * Produces a reasonable string representation for debugging, but primarily used
 * for serialisation (e.g. to JSON).
 *
 * 
 *
 */
public class RecentLog {
	...
	public String toString() {
		return String.format("%d %s %s %s: %s", getTimestamp(), getLevel(), getLogger(), getThread(), getMessage());
	}
}