...
/**
 * Common basic implementation for {@link
 * uk.gov.dstl.baleen.core.logging.builders.BaleenLoggerBuilder}.
 */
public abstract class AbstractBaleenLoggerBuilder implements BaleenLoggerBuilder {
   ...
   */
  protected AbstractBaleenLoggerBuilder(
  ...
  /**
   * Internal function to create a new appender, which is then called by {@link
   * #build(LoggerContext, Encoder)}. Child classes should implement this in order to create and
   * configure their specific appender.
   *
