 ...
 *
 * <p>Configuration can be accessed by either getting the whole YAML tree or by a path
 * representation e.g.:
 *
 * <p>"logging.enabled"
 *
...
public class YamlConfiguration {
   ...
   * @throws IOException
   */
  public static YamlConfiguration readFromResource(Class<?> clazz, String resourcePath)
      throws IOException {
