...
public final class BuilderUtils {
	...
	/**
	 * Take a configuration map, which may contain nested maps, and flatten it so that
	 * any nested parameters are expressed using dot notation.
	 * 
	 * @param key
	 * 		The top level key for this map, can be null
	 * @param config
	 * 		The map to flatten
	 * @return
	 * 		Flattened map
