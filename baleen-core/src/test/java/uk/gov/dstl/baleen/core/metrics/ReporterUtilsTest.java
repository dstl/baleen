...
/** Basic tests for {@link ReporterUtils} particularly instancing the default cases. */
public class ReporterUtilsTest {
  ...
  public void testCreatetConsoleReporter() {
    ScheduledReporter reporter =
        ReporterUtils.createConsoleReporter(registry, new HashMap<String, Object>());
  ...
  public void testCreateCsvReporter() throws BaleenException {
    ScheduledReporter reporter =
        ReporterUtils.createCsvReporter(registry, new HashMap<String, Object>());
    assertNotNull(reporter);
  }
