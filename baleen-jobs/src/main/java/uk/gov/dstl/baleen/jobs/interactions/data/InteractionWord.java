 ...
 * entities.
 *
 * <p>Since the word might connect many pairs (John and Sally went to London then Birmingham) we
 * allow for multiple relation pairs (John,London), (Sally, London), (John, Birmingham), (Sally,
 * Birmingham).
 */
public class InteractionWord {
   ...
   *
   * @param word the word
   * @param relationPairs the relation pairs
   */
