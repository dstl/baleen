 ...
 * removed from the classpath). Updated by JCasGen Wed Apr 13 13:23:15 BST 2016
 *
 * @generated
 */
public class DocumentAnnotation_Type extends Annotation_Type {
  ...
  public String getDocumentCaveats(int addr, int i) {
    ...
    if (lowLevelTypeChecks)
      return ll_cas.ll_getStringArrayValue(
          ll_cas.ll_getRefValue(addr, casFeatCode_documentCaveats), i, true);
    jcas.checkArrayBounds(ll_cas.ll_getRefValue(addr, casFeatCode_documentCaveats), i);
    return ll_cas.ll_getStringArrayValue(
        ll_cas.ll_getRefValue(addr, casFeatCode_documentCaveats), i);
  }
  ...
  public void setDocumentCaveats(int addr, int i, String v) {
    if (featOkTst && casFeat_documentCaveats == null)
      jcas.throwFeatMissing("documentCaveats", "uima.tcas.DocumentAnnotation");
    if (lowLevelTypeChecks)
      ll_cas.ll_setStringArrayValue(
          ll_cas.ll_getRefValue(addr, casFeatCode_documentCaveats), i, v, true);
    jcas.checkArrayBounds(ll_cas.ll_getRefValue(addr, casFeatCode_documentCaveats), i);
  ...
  public String getDocumentReleasability(int addr, int i) {
    ...
    if (lowLevelTypeChecks)
      return ll_cas.ll_getStringArrayValue(
          ll_cas.ll_getRefValue(addr, casFeatCode_documentReleasability), i, true);
    jcas.checkArrayBounds(ll_cas.ll_getRefValue(addr, casFeatCode_documentReleasability), i);
    return ll_cas.ll_getStringArrayValue(
        ll_cas.ll_getRefValue(addr, casFeatCode_documentReleasability), i);
  }
  ...
  public void setDocumentReleasability(int addr, int i, String v) {
    ...
    if (lowLevelTypeChecks)
      ll_cas.ll_setStringArrayValue(
          ll_cas.ll_getRefValue(addr, casFeatCode_documentReleasability), i, v, true);
    jcas.checkArrayBounds(ll_cas.ll_getRefValue(addr, casFeatCode_documentReleasability), i);
    ll_cas.ll_setStringArrayValue(
        ll_cas.ll_getRefValue(addr, casFeatCode_documentReleasability), i, v);
  }
  ...
  public DocumentAnnotation_Type(JCas jcas, Type casType) {
    ...
    casFeatCode_docType =
        (null == casFeat_docType)
            ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_docType).getCode();
    ...
    casFeat_documentClassification =
        jcas.getRequiredFeatureDE(casType, "documentClassification", "uima.cas.String", featOkTst);
    casFeatCode_documentClassification =
        (null == casFeat_documentClassification)
            ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_documentClassification).getCode();

    casFeat_documentCaveats =
        jcas.getRequiredFeatureDE(casType, "documentCaveats", "uima.cas.StringArray", featOkTst);
    casFeatCode_documentCaveats =
        (null == casFeat_documentCaveats)
            ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_documentCaveats).getCode();

    casFeat_documentReleasability =
        jcas.getRequiredFeatureDE(
            casType, "documentReleasability", "uima.cas.StringArray", featOkTst);
    casFeatCode_documentReleasability =
        (null == casFeat_documentReleasability)
            ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_documentReleasability).getCode();
  }
}
