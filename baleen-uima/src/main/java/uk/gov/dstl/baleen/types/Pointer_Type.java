 ...
 * coreference). Updated by JCasGen Wed Apr 13 13:23:15 BST 2016
 *
 * @generated
 */
public class Pointer_Type extends BaleenAnnotation_Type {
  ...
  public static final boolean featOkTst =
      JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.Pointer");
  ...
  public Pointer_Type(JCas jcas, Type casType) {
    ...
    casFeat_target =
        jcas.getRequiredFeatureDE(
            casType, "target", "uk.gov.dstl.baleen.types.BaleenAnnotation", featOkTst);
    casFeatCode_target =
        (null == casFeat_target)
    ...
    casFeatCode_targetId =
        (null == casFeat_targetId)
            ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_targetId).getCode();
  }
}
