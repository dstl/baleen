...
public class TemplateRecord_Type extends Base_Type {
  ...
  public final static int typeIndexID = TemplateRecord.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.templates.TemplateRecord");
