...
public class TemplateFieldDefinition extends Base {
  ...
  */  
  ...
  public boolean getRepeat() {
    if (TemplateFieldDefinition_Type.featOkTst && ((TemplateFieldDefinition_Type)jcasType).casFeat_repeat == null)
      jcasType.jcas.throwFeatMissing("repeat", "uk.gov.dstl.baleen.types.templates.TemplateFieldDefinition");
    return jcasType.ll_cas.ll_getBooleanValue(addr, ((TemplateFieldDefinition_Type)jcasType).casFeatCode_repeat);}
  ...
  public void setRepeat(boolean v) {
    if (TemplateFieldDefinition_Type.featOkTst && ((TemplateFieldDefinition_Type)jcasType).casFeat_repeat == null)
      jcasType.jcas.throwFeatMissing("repeat", "uk.gov.dstl.baleen.types.templates.TemplateFieldDefinition");
    jcasType.ll_cas.ll_setBooleanValue(addr, ((TemplateFieldDefinition_Type)jcasType).casFeatCode_repeat, v);}    
  }
