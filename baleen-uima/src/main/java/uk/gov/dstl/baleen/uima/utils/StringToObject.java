...
public class StringToObject {
   ...
   *
   * <p>This method accepts no configuration, and so uses default values
   *
   ...
   * represent a phone number
   *
   * <p>The following configuration keys can be set:
   *
   * <ul>
  ...
  /**
   * Test whether we should attempt to covert a string to a number, based on the current
   * configuration
   */
