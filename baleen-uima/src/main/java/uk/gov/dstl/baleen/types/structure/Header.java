...
public class Header extends Structure {
  ...
  */  
  ...
  public Page getPage() {
    ...
    return (Page)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Header_Type)jcasType).casFeatCode_page)));}
  ...
  public void setPage(Page v) {
    if (Header_Type.featOkTst && ((Header_Type)jcasType).casFeat_page == null)
      jcasType.jcas.throwFeatMissing("page", "uk.gov.dstl.baleen.types.structure.Header");
    jcasType.ll_cas.ll_setRefValue(addr, ((Header_Type)jcasType).casFeatCode_page, jcasType.ll_cas.ll_getFSRef(v));}    
  }
