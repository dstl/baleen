...
public class TablePart extends Structure {
  ...
  public final static int typeIndexID = JCasRegistry.register(TablePart.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected TablePart() {/* intentionally empty block */}
  ...
  */  
  ...
  public Table getTable() {
    ...
    return (Table)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((TablePart_Type)jcasType).casFeatCode_table)));}
  ...
  public void setTable(Table v) {
    if (TablePart_Type.featOkTst && ((TablePart_Type)jcasType).casFeat_table == null)
      jcasType.jcas.throwFeatMissing("table", "uk.gov.dstl.baleen.types.structure.TablePart");
    jcasType.ll_cas.ll_setRefValue(addr, ((TablePart_Type)jcasType).casFeatCode_table, jcasType.ll_cas.ll_getFSRef(v));}    
  }
