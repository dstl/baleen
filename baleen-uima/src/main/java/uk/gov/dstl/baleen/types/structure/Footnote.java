...
public class Footnote extends Structure {
  ...
  */  
  ...
  public Page getPage() {
    ...
    return (Page)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Footnote_Type)jcasType).casFeatCode_page)));}
  ...
  public void setPage(Page v) {
    if (Footnote_Type.featOkTst && ((Footnote_Type)jcasType).casFeat_page == null)
      jcasType.jcas.throwFeatMissing("page", "uk.gov.dstl.baleen.types.structure.Footnote");
    jcasType.ll_cas.ll_setRefValue(addr, ((Footnote_Type)jcasType).casFeatCode_page, jcasType.ll_cas.ll_getFSRef(v));}    
  }
