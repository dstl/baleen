...
public class Footer_Type extends Structure_Type {
  ...
  public final static int typeIndexID = Footer.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.structure.Footer");
