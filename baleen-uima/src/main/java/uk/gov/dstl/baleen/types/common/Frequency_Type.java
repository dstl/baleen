...
/**
 * A specific frequency value in the electro-magnetic spectrum (Hertz - Hz, MHz, GHz etc.). Updated
...
public class Frequency_Type extends Entity_Type {
  ...
  public static final int typeIndexID = Frequency.typeIndexID;
  /**
   * @generated
   * @modifiable
   */
  ...
  public static final boolean featOkTst =
      JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.common.Frequency");
