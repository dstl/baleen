...
public class Quantity_Type extends Entity_Type {
  ...
  public static final boolean featOkTst =
      JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.common.Quantity");
  ...
  public Quantity_Type(JCas jcas, Type casType) {
    ...
    casFeat_normalizedUnit =
        jcas.getRequiredFeatureDE(casType, "normalizedUnit", "uima.cas.String", featOkTst);
    casFeatCode_normalizedUnit =
        (null == casFeat_normalizedUnit)
            ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_normalizedUnit).getCode();

    casFeat_normalizedQuantity =
        jcas.getRequiredFeatureDE(casType, "normalizedQuantity", "uima.cas.Double", featOkTst);
    casFeatCode_normalizedQuantity =
        (null == casFeat_normalizedQuantity)
            ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_normalizedQuantity).getCode();

    casFeat_unit = jcas.getRequiredFeatureDE(casType, "unit", "uima.cas.String", featOkTst);
    casFeatCode_unit =
        (null == casFeat_unit) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl) casFeat_unit).getCode();
