...
public class PublishedId_Type extends BaleenAnnotation_Type {
  ...
  public final static int typeIndexID = PublishedId.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.metadata.PublishedId");
  ...
  public PublishedId_Type(JCas jcas, Type casType) {
    ...
    casFeat_publishedIdType = jcas.getRequiredFeatureDE(casType, "publishedIdType", "uima.cas.String", featOkTst);
    casFeatCode_publishedIdType  = (null == casFeat_publishedIdType) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_publishedIdType).getCode();
