...
public class Unordered_Type extends Structure_Type {
  ...
  public final static int typeIndexID = Unordered.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.structure.Unordered");
