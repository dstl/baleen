...
/**
 * A header of a Table. Updated by JCasGen Thu Dec 22 22:42:18 CET 2016
 *
 * @generated
 */
public class TablePart_Type extends Structure_Type {
  ...
  public static final int typeIndexID = TablePart.typeIndexID;
  /**
   * @generated
   * @modifiable
   */
  ...
  public static final boolean featOkTst =
      JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.structure.TablePart");
  ...
  public TablePart_Type(JCas jcas, Type casType) {
    ...
    casFeat_table =
        jcas.getRequiredFeatureDE(
            casType, "table", "uk.gov.dstl.baleen.types.structure.Table", featOkTst);
    casFeatCode_table =
        (null == casFeat_table)
            ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_table).getCode();
  }
}
