...
public class Style_Type extends Structure_Type {
  ...
  public static final int typeIndexID = Style.typeIndexID;
  /**
   * @generated
   * @modifiable
   */
  ...
  public static final boolean featOkTst =
      JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.structure.Style");
  ...
  public String getDecoration(int addr, int i) {
    ...
    if (lowLevelTypeChecks)
      return ll_cas.ll_getStringArrayValue(
          ll_cas.ll_getRefValue(addr, casFeatCode_decoration), i, true);
  ...
  public void setDecoration(int addr, int i, String v) {
    ...
    if (lowLevelTypeChecks)
      ll_cas.ll_setStringArrayValue(
          ll_cas.ll_getRefValue(addr, casFeatCode_decoration), i, v, true);
    jcas.checkArrayBounds(ll_cas.ll_getRefValue(addr, casFeatCode_decoration), i);
  ...
  public Style_Type(JCas jcas, Type casType) {
    ...
    casFeatCode_font =
        (null == casFeat_font) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl) casFeat_font).getCode();
    ...
    casFeat_decoration =
        jcas.getRequiredFeatureDE(casType, "decoration", "uima.cas.StringArray", featOkTst);
    casFeatCode_decoration =
        (null == casFeat_decoration)
            ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_decoration).getCode();

    casFeat_size = jcas.getRequiredFeatureDE(casType, "size", "uima.cas.String", featOkTst);
    casFeatCode_size =
        (null == casFeat_size) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl) casFeat_size).getCode();
  }
}
