...
/**
 * Metadata associated with the document Updated by JCasGen Tue Apr 12 12:06:57 BST 2016
 *
 * @generated
 */
public class Metadata_Type extends BaleenAnnotation_Type {
  ...
  public static final int typeIndexID = Metadata.typeIndexID;
  /**
   * @generated
   * @modifiable
   */
  ...
  public static final boolean featOkTst =
      JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.metadata.Metadata");
  ...
  public Metadata_Type(JCas jcas, Type casType) {
    ...
    casFeatCode_key =
        (null == casFeat_key) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl) casFeat_key).getCode();
