...
public class TemplateRecordDefinition_Type extends Base_Type {
  ...
  public static final int typeIndexID = TemplateRecordDefinition.typeIndexID;
  /**
   * @generated
   * @modifiable
   */
  ...
  public static final boolean featOkTst =
      JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.templates.TemplateRecordDefinition");
