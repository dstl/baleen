...
public class Style extends Structure {
  ...
  */  
  ...
  public void setDecoration(StringArray v) {
    if (Style_Type.featOkTst && ((Style_Type)jcasType).casFeat_decoration == null)
      jcasType.jcas.throwFeatMissing("decoration", "uk.gov.dstl.baleen.types.structure.Style");
    jcasType.ll_cas.ll_setRefValue(addr, ((Style_Type)jcasType).casFeatCode_decoration, jcasType.ll_cas.ll_getFSRef(v));}    
    
  /** indexed getter for decoration - gets an indexed value - Decoration applied to the text. For example, [italic, bold, underline]. 
   * @generated
  ...
  public String getDecoration(int i) {
    if (Style_Type.featOkTst && ((Style_Type)jcasType).casFeat_decoration == null)
      jcasType.jcas.throwFeatMissing("decoration", "uk.gov.dstl.baleen.types.structure.Style");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((Style_Type)jcasType).casFeatCode_decoration), i);
    return jcasType.ll_cas.ll_getStringArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((Style_Type)jcasType).casFeatCode_decoration), i);}

  /** indexed setter for decoration - sets an indexed value - Decoration applied to the text. For example, [italic, bold, underline]. 
   * @generated
  ...
  public void setDecoration(int i, String v) { 
    if (Style_Type.featOkTst && ((Style_Type)jcasType).casFeat_decoration == null)
      jcasType.jcas.throwFeatMissing("decoration", "uk.gov.dstl.baleen.types.structure.Style");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((Style_Type)jcasType).casFeatCode_decoration), i);
    jcasType.ll_cas.ll_setStringArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((Style_Type)jcasType).casFeatCode_decoration), i, v);}
