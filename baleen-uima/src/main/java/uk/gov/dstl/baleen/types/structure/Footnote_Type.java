 ...
 * @generated */
public class Footnote_Type extends Structure_Type {
  /** @generated */
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.structure.Footnote");
  ...
  public int getPage(int addr) {
      ...
      jcas.throwFeatMissing("page", "uk.gov.dstl.baleen.types.structure.Footnote");
  ...
  public Footnote_Type(JCas jcas, Type casType) {
    ...
    casFeat_page = jcas.getRequiredFeatureDE(casType, "page", "uk.gov.dstl.baleen.types.structure.Page", featOkTst);
