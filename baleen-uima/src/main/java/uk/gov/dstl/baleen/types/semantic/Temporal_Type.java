...
public class Temporal_Type extends Entity_Type {
  ...
  public static final int typeIndexID = Temporal.typeIndexID;
  /**
   * @generated
   * @modifiable
   */
  ...
  public static final boolean featOkTst =
      JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.semantic.Temporal");
  ...
  public Temporal_Type(JCas jcas, Type casType) {
    ...
    casFeat_timestampStart =
        jcas.getRequiredFeatureDE(casType, "timestampStart", "uima.cas.Long", featOkTst);
    casFeatCode_timestampStart =
        (null == casFeat_timestampStart)
            ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_timestampStart).getCode();

    casFeat_timestampStop =
        jcas.getRequiredFeatureDE(casType, "timestampStop", "uima.cas.Long", featOkTst);
    casFeatCode_timestampStop =
        (null == casFeat_timestampStop)
            ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_timestampStop).getCode();

    casFeat_scope = jcas.getRequiredFeatureDE(casType, "scope", "uima.cas.String", featOkTst);
    casFeatCode_scope =
        (null == casFeat_scope)
            ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_scope).getCode();

    casFeat_temporalType =
        jcas.getRequiredFeatureDE(casType, "temporalType", "uima.cas.String", featOkTst);
    casFeatCode_temporalType =
        (null == casFeat_temporalType)
            ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_temporalType).getCode();

    casFeat_precision =
        jcas.getRequiredFeatureDE(casType, "precision", "uima.cas.String", featOkTst);
    casFeatCode_precision =
        (null == casFeat_precision)
            ? JCas.INVALID_FEATURE_CODE
