...
public class Footer extends Structure {
  ...
  public final static int typeIndexID = JCasRegistry.register(Footer.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Footer() {/* intentionally empty block */}
  ...
  */  
  ...
  public Page getPage() {
    ...
    return (Page)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Footer_Type)jcasType).casFeatCode_page)));}
  ...
  public void setPage(Page v) {
    if (Footer_Type.featOkTst && ((Footer_Type)jcasType).casFeat_page == null)
      jcasType.jcas.throwFeatMissing("page", "uk.gov.dstl.baleen.types.structure.Footer");
    jcasType.ll_cas.ll_setRefValue(addr, ((Footer_Type)jcasType).casFeatCode_page, jcasType.ll_cas.ll_getFSRef(v));}    
  }
