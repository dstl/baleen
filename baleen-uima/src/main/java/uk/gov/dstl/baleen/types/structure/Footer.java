...
/**
 * A Footer of a Document. Updated by JCasGen Wed Apr 17 13:42:16 BST 2019 XML source:
...
public class Footer extends Structure {
  ...
  public static final String _TypeName = "uk.gov.dstl.baleen.types.structure.Footer";
  ...
  private static final CallSite _FC_page = TypeSystemImpl.createCallSite(Footer.class, "page");
   ...
   */
  public Footer(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
