...
public class UimaUtils {
	...
	/**
	 * Get the name of the pipeline which owns this context. This is set in
	...
	/**
	 * Should we merge distinct entities or not,
	 * based on the global configuration parameter <em>history.mergeDistinctEntities</em>
