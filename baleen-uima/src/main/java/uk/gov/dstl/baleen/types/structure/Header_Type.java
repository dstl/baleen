 ...
 * @generated */
public class Header_Type extends Structure_Type {
  /** @generated */
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.structure.Header");
  ...
  public int getPage(int addr) {
      ...
      jcas.throwFeatMissing("page", "uk.gov.dstl.baleen.types.structure.Header");
