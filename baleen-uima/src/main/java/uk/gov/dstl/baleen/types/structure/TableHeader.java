...
public class TableHeader extends TablePart {
  ...
  public final static int typeIndexID = JCasRegistry.register(TableHeader.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected TableHeader() {/* intentionally empty block */}
   ...
   */
  public TableHeader(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
