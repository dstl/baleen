...
/**
 * A link in a Document to an Anchor or other. Updated by JCasGen Thu Dec 22 22:42:17 CET 2016
 *
 * @generated
 */
public class Link_Type extends Structure_Type {
  ...
  public static final int typeIndexID = Link.typeIndexID;
  /**
   * @generated
   * @modifiable
   */
  ...
  public static final boolean featOkTst =
      JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.structure.Link");
