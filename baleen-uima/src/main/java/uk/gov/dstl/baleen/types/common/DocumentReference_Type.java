...
public class DocumentReference_Type extends Entity_Type {
  ...
  public static final int typeIndexID = DocumentReference.typeIndexID;
  /**
   * @generated
   * @modifiable
   */
  ...
  public static final boolean featOkTst =
      JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.common.DocumentReference");
