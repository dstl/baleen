...
/**
 * Specific amount of some current mentioned within the document. Updated by JCasGen Wed Apr 13
 * 13:23:15 BST 2016
 *
 * @generated
 */
public class Money_Type extends Entity_Type {
  ...
  public static final int typeIndexID = Money.typeIndexID;
  /**
   * @generated
   * @modifiable
   */
  ...
  public static final boolean featOkTst =
      JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.common.Money");
  ...
  public Money_Type(JCas jcas, Type casType) {
    ...
    casFeatCode_currency =
        (null == casFeat_currency)
            ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_currency).getCode();
  }
}
